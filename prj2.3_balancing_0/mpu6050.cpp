...
void mpu6050_loop()
{
  ...
  */
  ...
  //g_temp = ( (double) accel_t_gyro.value.temperature + 12412.0) / 340.0;
  //Serial.print(g_temo, 3);
...
void loop()
{
  ...
  Serial.print(g_temp);
  Serial.print(", ");
  Serial.print("accel_angle x, y, z = ");
  dtostrf(g_accel_angle_x, 8, 2, buf); Serial.print(buf); Serial.print(", ");
  dtostrf(g_accel_angle_y, 8, 2, buf); Serial.print(buf); Serial.print(", ");
  dtostrf(g_accel_angle_z, 8, 2, buf); Serial.print(buf); Serial.print(", ");
  Serial.print("angle x, y, z = ");
  dtostrf(g_angle_x, 8, 2, buf); Serial.print(buf); Serial.print(", ");
  dtostrf(g_angle_y, 8, 2, buf); Serial.print(buf); Serial.print(", ");
  dtostrf(g_angle_z, 8, 2, buf); Serial.print(buf); Serial.print(", ");
  Serial.println(F(""));
